...
__exportStar(require("./models/travel-models"), exports);
var prisma = new client_1.PrismaClient();
var createItem = function (newTravel) { return __awaiter(void 0, void 0, void 0, function () {
    var travel, travelDto;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma.expense.create({
                    data: {
                        /*
                        date: newTravel.date,
                        */
